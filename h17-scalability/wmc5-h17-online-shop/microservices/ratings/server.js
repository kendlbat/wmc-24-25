...
import ratingsHandlers from "./api/ratings-handlers.js";

import { logger } from "./logging.js";
import { setupDBConnection, dropCurrentDatabase } from "./db/database.js";

logger.info("RatingsService - Starting up...");
...
const MONGODB_CONNECTION_STRING =
    ...
    "mongodb://127.0.0.1:27017/online-shop-ratings";
...
httpServer.listen(PORT, HOSTNAME, () => {
    logger.info(`RatingsService - Running on port ${PORT}...`);
});
